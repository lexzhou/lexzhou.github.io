...
Hi there 👋, I am Lexin. I am a MPhil candidate in ML at [Cambridge University](https://www.cam.ac.uk/) and Data Science B.Sc student at [TU Valencia (UPV)](http://www.upv.es/). I currently work as a junior researcher with a national fellowship at [Valencian Research Institute for Artificial Intelligence - VRAIN](https://vrain.upv.es/) with [Prof. José Hernández-Orallo](http://josephorallo.webs.upv.es/) and [Prof. Fernando Martínez-Plumed](https://nandomp.github.io/). I also work as a Contracted Expert on AI Research at the [European Comission JRC](https://joint-research-centre.ec.europa.eu/jrc-sites-across-europe_en). My bit is to make AI more socially beneficial, better evaluate the systems we build, anticipate what they are capable of, and deploy them safely. My main research agenda encompasses several areas of Artificial Intelligence, Evaluation of AI, AI Safety, Scalable Oversight, AI alignment, General Purpose AI, and Foundation Models. Feel free to take a glance at my [CV](https://drive.google.com/file/d/18tiwYHt7vhufPDwj4cXCUtHbyNG8k7nX/view?usp=sharing).
