...
Hi! I'm a CS PhD student at Princeton University, advised [Peter Henderson](https://www.peterhenderson.co/) at the [POLARIS Lab](https://www.polarislab.org/). I am a computer scientist by training but also regularly draw insights from cognitive science. At present, I'm particularly interested in designing systematic evaluation frameworks that allow for understanding the capabilities and generalization patterns of LLMs, as well as their associated risks (e.g. unreliability). I also search for ways to disapprove Goodhart's Law through generalizable optimization targets and evaluations. To this end, I also closely collaborate with [Tom Griffiths](https://cocosci.princeton.edu/tom/index.php) as part of the [Princeton AI Lab](https://ai.princeton.edu/ai-lab).

Before joining Princeton, I was a StarBridge Scholar at Microsoft Research for a year, working with Dr. [Xing Xie][xxie].  I did my master's in CS at the University of Cambridge, funded by [Open Philanthropy][op] and supervised by [Andreas Vlachos][avlachos], and my BSc in Data Science at the Universitat Politècnica de València, where I got into research by working with [Jose Hernandez-Orallo][jhorallo].
